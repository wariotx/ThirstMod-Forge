...
public class Configuration
{
    ...
    public static final String CATEGORY_GENERAL = "Options";
                        ...
                        else
                        {
                            switch (line.charAt(i))
                            {
                                ...
                                case ':':
                                    ...
                                    break;
                                default:
                                    throw new RuntimeException("unknown character: " + line.charAt(i) + " Please delete the configuration file.");
                            }
                        }
                    }
                }
    ...
    public void save()
    {
        try
        {
            ...
            if (file.canWrite())
            {
                ...
                buffer.write("# ThirstMod Configuration file\r\n");
                buffer.write("# Current Version: " + ThirstUtils.getVersion() + "\r\n");
                buffer.write("# Generated on " + DateFormat.getInstance().format(new Date()) + "\r\n\r\n");
                buffer.write("# Modify the settings here. Be sure to keep to the format.\r\n");
                buffer.write("\r\n");
