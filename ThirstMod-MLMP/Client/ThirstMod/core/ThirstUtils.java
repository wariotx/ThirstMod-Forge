...
public class ThirstUtils 
{
	...
	{
		if (ModLoader.getMinecraftInstance().thePlayer.capabilities.disableDamage)
		{
			return;
		}
		if (!ModLoader.getMinecraftInstance().thePlayer.worldObj.isRemote)
		{
			thirstStats.addExhaustion(f);
		}
	}
