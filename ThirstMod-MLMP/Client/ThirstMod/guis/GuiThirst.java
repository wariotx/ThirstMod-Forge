...
public class GuiThirst extends GuiIngame
{
    ...
    public GuiThirst(Minecraft par1Minecraft)
    {
    	super(par1Minecraft);
            ...
            if (mc.playerController.shouldDrawHUD())
            {
                ...
                for (int j10 = 0; j10 < 10; j10++)
                {
                    if (j9 > 0)
                    {
                        ...
                        if(mod_ThirstMod.isThirstMeterOnLeft == true)
                        {
                        	i11 = j5 + j10 * 8 + 100;
                        }
                ...
                ThirstStats thirststats = ThirstUtils.getStats();
                int thirstLvl = thirststats.getThirstLevel();
                int prevThirstLvl = thirststats.getPrevThirstLevel();
                for(int i13 = 0; i13 < 10; i13++)
            	{
                	int width = scaledresolution.getScaledWidth() / 2 + 91 - i13 * 8 - 9;
            		...
            		if(ThirstUtils.getStats().getThirstSaturationLevel() <= 0.0F && updateCounter % (thirstLvl * 3 + 1) == 0)
            		{
            		...
            		if(mod_ThirstMod.isThirstMeterOnLeft == true)
            		{
            			width = scaledresolution.getScaledWidth() / 2 - 91 + i13 * 8;
            		}
            		
            		if(mod_ThirstMod.oldTextures == true)
            		{
            			textureYStart = 12;
            		}
            		...
            		if(ThirstUtils.getStats().isThirstPoisoned == false)
            		{
            			if(i13 * 2 + 1 < thirstLvl)
                    	{
                    		drawTexturedModalRect(width, height, textureXStart + 9, textureYStart, textureEndX, textureEndY);//(x-coor, y-coor, txt x Start, txt y start, txt x end, txt y end)
                    	}
            		...
            		else if(ThirstUtils.getStats().isThirstPoisoned == true)
            		{
                		if(i13 * 2 + 1 < thirstLvl)
                		{
                			drawTexturedModalRect(width, height, textureXStart + 27, textureYStart, textureEndX, textureEndY);//(x-coor, y-coor, txt x Start, txt y start, txt x end, txt y end)
                		}
                ...
                if (mc.thePlayer.isInsideOfMaterial(Material.water))
                {
                    ...
                    for (int i13 = 0; i13 < l11 + k12; i13++)
                    {
                        if (i13 < l11)
                        {
                            drawTexturedModalRect(i6 - i13 * 8 - 10, k8 + offset, 16, 18, 9, 9);
                        }
                        else
                        {
                            drawTexturedModalRect(i6 - i13 * 8 - 10, k8 + offset, 25, 18, 9, 9);
                        }
                    }
                }
            }
