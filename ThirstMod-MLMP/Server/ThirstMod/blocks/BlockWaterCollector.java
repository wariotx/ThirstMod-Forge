...
import net.minecraft.src.ThirstMod.containers.ContainerJM;
...
public class BlockWaterCollector extends BlockContainer
{
    ...
    public boolean blockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5)
    {
        ...
        else
        {
            ...
            if (var7 != null)
            {
            	ModLoader.openGUI(var5, 90, var7, new ContainerWaterCollector(var5.inventory, var7));
            }
        }	
        return true;
    }
