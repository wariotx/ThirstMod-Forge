	...
	public void renderGameOverlay(float par1, boolean par2, int par3, int par4) {
		...
		if (!this.mc.playerController.func_78747_a()) {
			...
			if (this.mc.playerController.shouldDrawHUD()) {
				...
				String modTurnedOff = "Thirst Mod was turned off!";
				String modTurnedOn = "Thirst Mod was turned on!";
		...
		if (this.mc.isDemo()) {
			...
			if (this.mc.theWorld.getWorldTime() >= 120500L) {
				...
				var36 = String.format(StatCollector.translateToLocal("demo.remainingTime"), new Object[]
		...
		if (this.mc.gameSettings.showDebugInfo) {
			...
			this.drawString(var8, String.format("x: %.5f", new Object[]
			{ Double.valueOf(this.mc.thePlayer.posX) }), 2, 64, 14737632);
			this.drawString(var8, String.format("y: %.3f (feet pos, %.3f eyes pos)", new Object[]
			{ Double.valueOf(this.mc.thePlayer.boundingBox.minY), Double.valueOf(this.mc.thePlayer.posY) }), 2, 72, 14737632);
			this.drawString(var8, String.format("z: %.5f", new Object[]
			{ Double.valueOf(this.mc.thePlayer.posZ) }), 2, 80, 14737632);
			...
			this.drawString(var8, String.format("ws: %.3f, fs: %.3f, g: %b", new Object[]
			{ Float.valueOf(this.mc.thePlayer.capabilities.getWalkSpeed()), Float.valueOf(this.mc.thePlayer.capabilities.getFlySpeed()), Boolean.valueOf(this.mc.thePlayer.onGround) }), 2, 104, 14737632);
			GL11.glPopMatrix();
			this.mc.mcProfiler.endSection();
		}
