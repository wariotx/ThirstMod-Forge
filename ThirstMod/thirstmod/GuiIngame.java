        ...
        if (!this.mc.playerController.func_35643_e())
        {
            ...
            if (this.mc.playerController.shouldDrawHUD())
            {
              ...
              //draw Thirst Bar
                ...
                ThirstStats thirststats = Utilities.getStats();
                ...
                for(int i13 = 0; i13 < 10; i13++)
            	{
            		...
            		if(Utilities.getStats().saturation <= 0.0F && updateCounter % (thirstLvl * 3 + 1) == 0)
            		{
            		...
            		if(Utilities.getStats().poisoned == false)
            		{
            		...
            		else if(Utilities.getStats().poisoned == true)
            		{
                		if(i13 * 2 + 1 < thirstLvl)
                		{
                ...
                if (this.mc.thePlayer.isInsideOfMaterial(Material.water))
                {
                    ...
                    for (var28 = 0; var28 < var26 + var51; ++var28)
                    {
                        if (var28 < var26)
                        {
                            this.drawTexturedModalRect(var19 - var28 * 8 - 9, var22 + offset, 16, 18, 9, 9);
                        }
                        else
                        {
                            this.drawTexturedModalRect(var19 - var28 * 8 - 9, var22 + offset, 25, 18, 9, 9);
                        }
                    }
                }
            }
