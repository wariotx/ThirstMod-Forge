...
public class ItemDrinkContent extends Item implements ITextureProvider {
	...
	public ItemDrinkContent(int id, int thirstReplenish, float saturationModifier, boolean alwaysItemDrinkable) {
		super(id);
	...
	public ItemDrinkContent(int i, int j, boolean flag) {
		this(i, j, 0.2F, flag);
	}
	...
	public ItemDrinkContent setPotionEffect(int i, int j, int k, float f) {
		potionId = i;
		potionDuration = j;
		potionAmplifier = k;
	...
	public ItemDrinkContent setPoisoningChance(float chance) {
		poisonChance = chance;
		return this;
	}
	...
	public ItemDrinkContent setEffect(boolean b) {
		if (b == true) {
			hasEffect = true;
		} else if (b == false) {
		}
	...
	public ItemDrinkContent healFood(int level, float saturation) {
		foodHeal = level;
		satHeal = saturation;
		return this;
	}
	...
	public String getTextureFile() {
		return "/thirstmod/textures/content.png";
	}
}