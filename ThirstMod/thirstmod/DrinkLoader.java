...
import net.minecraft.src.thirstmod.itemmod.ItemBucketMilkMod;
import net.minecraft.src.thirstmod.itemmod.ItemPotionMod;
import net.minecraft.src.thirstmod.itemmod.ItemSoupMod;
import net.minecraft.src.thirstmod.items.ItemCanteen;
